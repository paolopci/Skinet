...
3) Modalita' di selezione checklist: mostra sempre una lista numerata in testo semplice con queste due opzioni, usando l'icona 🟡 per la scelta:
   ...
   - Se l'utente seleziona '1', esegui solo lo step indicato e aggiorna la checklist lasciando visibili gli step completati (🟧 barrati) e quelli rimanenti (🟦), rinumerando in modo progressivo solo gli step ancora da svolgere.
