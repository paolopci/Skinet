...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Angular API Docs</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CheckoutDeliveryComponent.html" data-type="entity-link" >CheckoutDeliveryComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/FiltersDialogComponent.html" data-type="entity-link" >FiltersDialogComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/OrderDetailsDialogComponent.html" data-type="entity-link" >OrderDetailsDialogComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/OrdersComponent.html" data-type="entity-link" >OrdersComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/OrderSummaryComponent.html" data-type="entity-link" >OrderSummaryComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/PaymentMethodsComponent.html" data-type="entity-link" >PaymentMethodsComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/FiltersDialogData.html" data-type="entity-link" >FiltersDialogData</a>
                            </li>
                            <li class="link">
